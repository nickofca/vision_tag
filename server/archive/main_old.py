...
@app.post("/scoreboard/")
async def create_scoreboard_json(game_id: str, game_name: str, scores: list):
    """
    Creates a JSON representation of a scoreboard.

    Args:
        game_id (str): The ID of the game.
        game_name (str): The name of the game.
        scores (list): A list of dictionaries, each containing 'player_id', 'player_name', and 'score'.

    Returns:
        str: A JSON string representing the scoreboard.
    """
    # Create the scoreboard dictionary
    scoreboard = {
        "scoreboard": {
            "game_id": game_id,
            "game_name": game_name,
    ...
    # Convert the scoreboard dictionary to a JSON string
    scoreboard_json = json.dumps(scoreboard, indent=4)

    return scoreboard_json


@app.post("/create_game/")
async def create_game(game_id: str, game_name: str, scores: list):
    add_game(game_id)